...
function loadObjects() {
    ...
    const treeText = document.getElementById("tree.obj").text;
    gSurfaceLibrary.set("tree",treeText);
...
function makeObject(objname, objtext) {
    ...
    if (objname != "tron-cycle" && objname != "tree") {
        //
        // Make faceted object.
        ...
        //
        // Little hack for the player/cycle and tree.
